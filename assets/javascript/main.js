$(document).ready(function() {
    ...
    let characters = {
        'revan': {
            ...
            health: 200,
            attack: 15,
            imageUrl: "assets/images/revan.jpg",
            enemyAttackBack: 15
        }, 
        'bastila': {
            name: 'bastila',
            health: 150,
            attack: 10,
            imageUrl: "assets/images/bastila.jpg",
            enemyAttackBack: 12
        }, 
        'carth': {
            name: 'carth',
            health: 125,
            attack: 8,
            imageUrl: "assets/images/carth.jpg",
            enemyAttackBack: 15
        }, 
        'canderous': {
            name: 'canderous',
            health: 115,
            attack: 14,
            imageUrl: "assets/images/canderous.jpg",
            enemyAttackBack: 20
        }
    };
